...
/// @nodoc
abstract class _$$SafeDropImplCopyWith<$Res> {
  factory _$$SafeDropImplCopyWith(
          _$SafeDropImpl value, $Res Function(_$SafeDropImpl) then) =
      __$$SafeDropImplCopyWithImpl<$Res>;
  @useResult
  $Res call({double amount, String reason});
}

/// @nodoc
class __$$SafeDropImplCopyWithImpl<$Res>
    extends _$ShiftEventCopyWithImpl<$Res, _$SafeDropImpl>
    implements _$$SafeDropImplCopyWith<$Res> {
  __$$SafeDropImplCopyWithImpl(
      _$SafeDropImpl _value, $Res Function(_$SafeDropImpl) _then)
      : super(_value, _then);
...
class _$SafeDropImpl implements _SafeDrop {
  const _$SafeDropImpl(this.amount, this.reason);
  ...
  @override
  String toString() {
    return 'ShiftEvent.safeDrop(amount: $amount, reason: $reason)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SafeDropImplCopyWith<_$SafeDropImpl> get copyWith =>
      __$$SafeDropImplCopyWithImpl<_$SafeDropImpl>(this, _$identity);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return safeDrop?.call(amount, reason);
  }
...
abstract class _SafeDrop implements ShiftEvent {
  const factory _SafeDrop(final double amount, final String reason) =
      _$SafeDropImpl;
...
abstract class _$$OpenImplCopyWith<$Res> {
  ...
  $Res call(
      ...
      double totalPayIn,
      double totalPayOut,
      double totalSafeDrops,
      double totalSales});

  $ShiftSessionCopyWith<$Res> get shift;
}
...
class __$$OpenImplCopyWithImpl<$Res>
    ...
    return _then(_$OpenImpl(
      ...
      totalPayOut: null == totalPayOut
          ...
          : totalPayOut // ignore: cast_nullable_to_non_nullable
              as double,
      totalSafeDrops: null == totalSafeDrops
          ? _value.totalSafeDrops
          : totalSafeDrops // ignore: cast_nullable_to_non_nullable
              as double,
  ...
  @pragma('vm:prefer-inline')
  $ShiftSessionCopyWith<$Res> get shift {
    return $ShiftSessionCopyWith<$Res>(_value.shift, (value) {
...
class _$OpenImpl implements _Open {
  ...
  @override
  String toString() {
    return 'ShiftState.open(shift: $shift, totalPayIn: $totalPayIn, totalPayOut: $totalPayOut, totalSafeDrops: $totalSafeDrops, totalSales: $totalSales)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totalSafeDrops, totalSafeDrops) ||
                other.totalSafeDrops == totalSafeDrops) &&
  ...
  int get hashCode => Object.hash(
      runtimeType, shift, totalPayIn, totalPayOut, totalSafeDrops, totalSales);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return open?.call(
        shift, totalPayIn, totalPayOut, totalSafeDrops, totalSales);
  }
...
abstract class _Open implements ShiftState {
  const factory _Open(final ShiftSession shift,
      {final double totalPayIn,
      final double totalPayOut,
      final double totalSafeDrops,
      final double totalSales}) = _$OpenImpl;

  ShiftSession get shift;
  double get totalPayIn;
  double get totalPayOut;
  double get totalSafeDrops;
