    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(colors: [Colors.purple.shade50, Colors.deepPurple.shade50]),
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
               ...
               child: SavvyText.label('+\$${_price.toStringAsFixed(2)}', color: Colors.purple),
            ),
          ],
        ),
      ),
    ).animate().fadeIn().slideX(begin: 0.1, curve: Curves.easeOutBack).shimmer(duration: 2.seconds, delay: 1.seconds);
  }
}
