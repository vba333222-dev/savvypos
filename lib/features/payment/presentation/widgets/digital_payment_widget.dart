  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SavvyText.h2('\$${widget.amount.toStringAsFixed(2)}', color: context.savvy.colors.primary),
        const SizedBox(height: 24),
          ...
          child: Stack(
            ...
            children: [
              ...
              if (_isSuccess)
                ...
                ).animate().scale(curve: Curves.elasticOut, duration: 500.ms).then().shake(),
              ...
              if (_isQrReady && !_isSuccess)
                 ...
                 ).animate(onPlay: (c) => c.repeat()).scale(begin: const Offset(1,1), end: const Offset(1.1, 1.1), duration: 1.seconds).fadeOut(),
            ],
          ),
        ),
        ...
        if (_isSuccess)
           const SavvyText.h3('Payment Received!', color: Colors.green).animate().fadeIn(),
