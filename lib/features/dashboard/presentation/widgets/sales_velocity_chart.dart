      ...
      children: [
        Row(
          ...
          children: [
             Column(
               crossAxisAlignment: CrossAxisAlignment.start,
               children: [
                 SavvyText('Sales Velocity', style: SavvyTextStyle.labelMedium, color: theme.colors.textSecondary),
                 SavvyText(
                    _hoverIndex != null 
             ...
             if (_hoverIndex != null)
               Container(
                 ...
                 child: Text(
                   '${_hoverIndex!}:00', 
                   style: TextStyle(color: theme.colors.textInverse, fontSize: 12),
                 ),
               ),
          ],
        ),
        ...
        Expanded(
          child: LineChart(
                ...
                bottomTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (value, meta) {
                      if (value % 4 == 0) { // Labels every 4 hours
                         return Padding(
            ...
            duration: const Duration(milliseconds: 300), // Subtle animation on updates
