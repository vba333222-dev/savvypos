...
class LoyaltyEvent with _$LoyaltyEvent {
  ...
  const factory LoyaltyEvent.enroll(
      String customerUuid, String name, String phone) = EnrollMember;
  const factory LoyaltyEvent.earnPoints(
      String customerUuid, double amount, String orderUuid) = EarnPoints;
  const factory LoyaltyEvent.redeemReward(
