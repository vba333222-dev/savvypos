...
class CashManagementDialog extends StatefulWidget {
  ...
  const CashManagementDialog({Key? key, required this.type}) : super(key: key);
...
class _CashManagementDialogState extends State<CashManagementDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final title = isPayIn ? 'Pay In (Add Cash)' : 'Pay Out (Remove Cash)';
    final color = isPayIn ? colors.stateSuccess : colors.stateError;
