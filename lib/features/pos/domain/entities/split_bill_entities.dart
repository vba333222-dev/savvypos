...
class SplitBill with _$SplitBill {
  ...
  factory SplitBill.fromJson(Map<String, dynamic> json) =>
      _$SplitBillFromJson(json);

  const SplitBill._();

  /// Total amount paid
  double get totalPaid => guestBills.fold<double>(
      0, (sum, g) => sum + (g.isPaid ? g.totalAmount : 0));
...
class GuestBill with _$GuestBill {
  ...
  factory GuestBill.fromJson(Map<String, dynamic> json) =>
      _$GuestBillFromJson(json);
...
class SplitPreset with _$SplitPreset {
  ...
  factory SplitPreset.fromJson(Map<String, dynamic> json) =>
      _$SplitPresetFromJson(json);
}
