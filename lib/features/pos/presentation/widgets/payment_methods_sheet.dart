            ...
            return Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.vertical(
                    top: Radius.circular(theme.shapes.radiusLg)),
                boxShadow: [
                  BoxShadow(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    mainAxisAlignment:
                                        MainAxisAlignment.spaceBetween,
                                    children: [
                                      SavvyText('Amount Paid',
                                          style: SavvyTextStyle.bodyLarge,
                                          color: theme.colors.textSecondary),
                                      SavvyText(
                                          '\$${checkoutState.amountPaid.toStringAsFixed(2)}',
                                          style: SavvyTextStyle.h3,
                                          color: theme.colors.textPrimary),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      SavvyText('Remaining',
                                          ...
                                          color: theme.colors.textSecondary),
                                      SavvyText(
                                          '\$${checkoutState.remainingBalance.toStringAsFixed(2)}',
                                          style: SavvyTextStyle.h2,
                            ...
                            if (checkoutState.paymentParts.isNotEmpty) ...[
                              SavvyText('Partial Payments',
                                  style: SavvyTextStyle.label,
                                  color: theme.colors.textSecondary),
                              SizedBox(height: theme.shapes.spacingSm),
                              ...checkoutState.paymentParts
                                  .asMap()
                                  .entries
                                  .map((entry) {
                                int idx = entry.key;
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Icon(
                                            part.method == PaymentMethod.cash
                                                ? Icons.money
                                                : part.method ==
                                                        PaymentMethod.card
                                                    ? Icons.credit_card
                            ...
                            if (_selectedMethod == 'CASH') ...[
                              ...
                              Builder(builder: (builderContext) {
                                final suggestions =
                                    SmartCashHelper.generateSuggestions(
                                        checkoutState.remainingBalance);
                                return Row(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceEvenly,
                                  children: suggestions.map((amount) {
                                    final isExact = amount ==
                                        checkoutState.remainingBalance;
                                    final label = isExact
                                        ? 'Exact'
                                        : '\$${amount.toStringAsFixed(0)}'; // Or 2 decimals if needed

                                    return _QuickCashBtn(
                                        label,
                                        () => _handleSmartCash(
                                            amount, builderContext));
                                  }).toList(),
                                );
                              }),
                              SizedBox(height: theme.shapes.spacingMd),
                              ...
                              Center(
                                child: Column(
                                  children: [
                                    ...
                                    SizedBox(height: 16),
                                    SavvyText(
                                        'Use Terminal to Complete Payment',
                                        style: SavvyTextStyle.bodyLarge),
                                  ],
                                ),
                              ),
                            ...
                            SizedBox(
                                height:
                                    80), // Bottom padding for FAB/Button space
                          ],
                        ),
                      ),
                    ),
                      ...
                      children: [
                                      ...
                                      context.read<CheckoutBloc>().add(
                                            ...
                                            method: _selectedMethod == 'CASH'
                                                ...
                                                : _selectedMethod == 'CARD'
                                                    ...
                                                    : PaymentMethod.qris,
                                            amount: amountToAdd,
                                            tendered: _selectedMethod == 'CASH'
                                                ? tenderAmount
                                                : null,
                                            change: _selectedMethod == 'CASH'
                                                ? change
                                                : null,
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  checkoutState.remainingBalance <= 0.01
                                      ? theme.colors.stateSuccess
                            ...
                            child: SavvyText(
                                checkoutState.remainingBalance <= 0.01
                                    ? 'FINISH PAYMENT'
                                    : 'REMAINING \$${checkoutState.remainingBalance.toStringAsFixed(2)}',
                                style: SavvyTextStyle.h3,
                                color: checkoutState.remainingBalance <= 0.01
  ...
  void _handleSmartCash(double amount, BuildContext builderContext) {
    ...
    final snackBar = SnackBar(
      ...
      duration: const Duration(
          milliseconds:
              1000), // Give slightly more visual time, but trigger fast
    ...
    _smartPayTimer = Timer(const Duration(milliseconds: 800), () {
      ...
      if (mounted) {
        ...
        builderContext
            .read<CheckoutBloc>()
            .add(CheckoutEvent.addPaymentPart(PaymentPart(
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              isSelected ? theme.colors.brandPrimary : theme.colors.bgPrimary,
          borderRadius: BorderRadius.circular(theme.shapes.radiusMd),
          border: Border.all(
              color: isSelected
                  ? theme.colors.brandPrimary
