...
abstract class IAdvancedInventoryRepository {
  ...
  Future<void> updateStockLevel(
      String productUuid, String warehouseUuid, double newQuantity);
  ...
  Future<StockAlertConfig?> getAlertConfig(
      String productUuid, String? warehouseUuid);
  ...
  Future<void> receiveTransfer(
      String uuid, List<AdvancedStockTransferItem> items, String receivedBy);
