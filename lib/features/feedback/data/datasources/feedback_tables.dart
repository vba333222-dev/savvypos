...
class CustomerFeedbackTable extends Table {
  ...
  TextColumn get customerUuid => text().nullable().references(CustomerTable, #uuid)();
  IntColumn get rating => integer()(); // 1-5
  TextColumn get sentiment => text().withDefault(const Constant('neutral'))(); // positive, negative, neutral
  TextColumn get tags => text().nullable()(); // JSON list of tags
  TextColumn get comment => text().nullable()();
  
  BoolColumn get isActioned => boolean().withDefault(const Constant(false))(); // For manager workflow
