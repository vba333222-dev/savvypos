...
class StaffAlertRepositoryImpl implements IStaffAlertRepository {
  ...
  Future<List<StaffAlert>> getActiveAlerts() async {
    ...
    final rows = await (_db.select(_db.staffAlertTable)
          ...
          ..where(
              (t) => t.expiresAt.isNull() | t.expiresAt.isBiggerThanValue(now))
  ...
  Stream<int> watchActiveAlertCount() {
    ...
    return (_db.selectOnly(_db.staffAlertTable)
          ...
          ..where(_db.staffAlertTable.expiresAt.isNull() |
              _db.staffAlertTable.expiresAt.isBiggerThanValue(now)))
        .watch()
  ...
  @override
  Future<StaffAlert> sendCustomerAssistanceAlert(
      String tableUuid, String tableName, String message) {
    return createAlert(
