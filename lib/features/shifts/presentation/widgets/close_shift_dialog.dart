...
class _CloseShiftDialogState extends State<CloseShiftDialog> {
        ...
        title: Row(
          children: [
            Icon(Icons.warning_amber_rounded,
                color: theme.colors.stateWarning, size: 28),
            const SizedBox(width: 8),
            Text('Cash Variance Detected',
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (reasonController.text.trim().isEmpty) {
                ScaffoldMessenger.of(ctx).showSnackBar(
                  SnackBar(
                      content: Text('Variance reason is mandatory',
            ...
            style: ElevatedButton.styleFrom(
              ...
              foregroundColor:
                  theme.colors.textPrimary, // Better contrast on yellow/warning
            ),
  ...
  void _submitCloseShift(String? varianceReason) {
    ...
    context.read<ShiftBloc>().add(
        ShiftEvent.closeShift(_actualCash, varianceReason: varianceReason));
  }
      ...
      listener: (context, state) {
        state.maybeWhen(
          ...
          closed: () {
            ...
            debugPrint(
                '[Cache] Image cache flushed on shift close. RAM freed.');
        ...
        return AlertDialog(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: _denominations.map((d) {
                                ...
                                return InkWell(
                                  onTap: () =>
                                      setState(() => _activeDenomination = d),
                                  child: Container(
          ...
          actions: [
            ...
            ElevatedButton.icon(
              onPressed: isLoading
                  ? null
                  : (_actualCash > 0 || widget.currentShift.startCash == 0
                      ? _handleCloseShift
                      : null),
              style: ElevatedButton.styleFrom(
              ...
              label: Text(isLoading ? 'Processing...' : 'Submit Count & Close',
