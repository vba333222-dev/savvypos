...
class _KitchenMonitorPageState extends State<KitchenMonitorPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) =>
          GetIt.I<KitchenBloc>()..add(const KitchenEvent.startListening()),
      child: Scaffold(
            ...
            BlocBuilder<KitchenBloc, KitchenState>(
              builder: (context, state) {
                final count = state.maybeWhen(
                    loaded: (orders) => orders.length, orElse: () => 0);
                return Padding(
                ...
                return MasonryGridView.count(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return KitchenOrderCard(
                      ...
                      onBump: () => context
                          .read<KitchenBloc>()
                          .add(KitchenEvent.markAsDone(order.uuid)),
                    )
                        .animate()
                        .slideX(
                            begin: -0.5,
