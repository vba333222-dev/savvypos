...
class TipPoolConfigTable extends Table {
  ...
  TextColumn get method => text().withDefault(const Constant('equal'))(); // equal, hoursWorked, points, percentage
  BoolColumn get isActive => boolean().withDefault(const Constant(true))();
  
  // JSON stored configurations
  TextColumn get rolePercentagesJson => text().withDefault(const Constant('{}'))();
  TextColumn get rolePointsJson => text().withDefault(const Constant('{}'))();
  TextColumn get excludedRolesJson => text().withDefault(const Constant('[]'))();
