...
class FeatureTourOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = context.savvy; // This works if context has SavvyTheme, otherwise might fail in Dialog context if not wrapped. 
    // Usually Dialogs are above app, but inherit theme.
