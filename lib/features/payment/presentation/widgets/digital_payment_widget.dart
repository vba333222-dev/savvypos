...
class _DigitalPaymentWidgetState extends State<DigitalPaymentWidget> {
  ...
  void _simulateFlow() async {
    ...
    final mockQrString =
        '00020101021126660016COM.GOJEK.WWW01189360091531580252510209580252515204581253033605407${widget.amount}5802ID5912Savvy Bistro6007Jakarta61051211062070703A016304EE88';

    // 1. Simulate API Call to Get QR
    await Future.delayed(const Duration(seconds: 1));
    if (mounted) {
      setState(() => _isQrReady = true);
      socketService.simulateIncomingMessage(
          'CDS_PAYMENT_REQUEST', {'qr_data': mockQrString});
    }
    ...
    if (mounted) {
      ...
      socketService.simulateIncomingMessage(
          'CDS_SUCCESS', {'points': (widget.amount * 0.1).toInt()});
