...
class DataSeeder {
  ...
  Future<void> _seedRetail() async {
    ...
    await _createProduct('Basic T-Shirt', 15.00, catMens, sku: 'TSH-001', trackStock: true);
    await _createProduct('Jeans', 45.00, catMens, sku: 'JNS-001', trackStock: true);
  ...
  Future<void> _createProduct(String name, double price, String catId, {String? sku, bool trackStock = false, bool isService = false}) async {
    final id = _uuid.v4();
