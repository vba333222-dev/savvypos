...
class StaffAlert with _$StaffAlert {
  ...
  factory StaffAlert.fromJson(Map<String, dynamic> json) => _$StaffAlertFromJson(json);
...
class AlertTemplate with _$AlertTemplate {
  ...
  factory AlertTemplate.fromJson(Map<String, dynamic> json) => _$AlertTemplateFromJson(json);
}
