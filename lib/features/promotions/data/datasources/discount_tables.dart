...
class DiscountTable extends Table {
  ...
  TextColumn get applicableProductUuidsJson =>
      text().withDefault(const Constant('[]'))();
  TextColumn get applicableCategoryUuidsJson =>
      text().withDefault(const Constant('[]'))();
  TextColumn get applicableCustomerUuidsJson =>
      text().withDefault(const Constant('[]'))();
