          ...
          child: SizedBox(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                   Text("New Purchase Order", style: Theme.of(context).textTheme.headlineSmall),
                   ...
                   DropdownButtonFormField<String>(
                     ...
                     items: state.suppliers.map((s) => DropdownMenuItem(value: s.uuid, child: Text(s.name))).toList(),
                     ...
                     children: [
                       Expanded(
                         child: TextField(
                           ...
                           decoration: const InputDecoration(hintText: "Product UUID (Mock)"),
                         ),
                       ),
                       IconButton(
                           ...
                           if (_productSearchCtrl.text.isNotEmpty) {
                             setState(() {
                               _items.add(PurchaseOrderItem(
                                 ...
                                 productName: "Product ${_productSearchCtrl.text}",
                                 quantityOrdered: 1, 
                                 quantityReceived: 0, 
                   ...
                   Expanded(
                     child: ListView.separated(
                       ...
                       itemBuilder: (context, index) {
                         ...
                         return ListTile(
                           title: Text(item.productName ?? item.productUuid ?? 'Unknown Item'),
                                 ...
                                 Expanded(
                                   child: TextField(
                                      ...
                                      onChanged: (v) {
                                         ...
                                         _items[index] = item.copyWith(quantityOrdered: val);
                                      },
                                   ),
                                 ),
                                 IconButton(
                   ...
                   SizedBox(
                     ...
                     child: ElevatedButton(
                       onPressed: _selectedSupplierUuid == null || _items.isEmpty
                         ? null
                         : () {
                             context.read<InventoryBloc>().add(InventoryEvent.createPo(
