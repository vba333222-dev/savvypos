...
class EmployeeExtendedTable extends Table {
  ...
  TextColumn get employeeUuid =>
      text().unique()(); // References EmployeeTable.uuid

  RealColumn get hourlyRate => real().withDefault(const Constant(0))();
  RealColumn get salary => real().withDefault(const Constant(0))();
  TextColumn get payType =>
      text().withDefault(const Constant('hourly'))(); // hourly, salary
  TextColumn get employmentStatus =>
