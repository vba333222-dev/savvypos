    ...
    switch (session.currentStep) {
      case KioskFlowStep.welcome:
        return KioskWelcomePage(
          ...
          onStart: () =>
              _kioskRepo.updateStep(session.uuid, KioskFlowStep.diningOption),
        );
      ...
      case KioskFlowStep.menu:
        return KioskMenuPage(
          ...
          session: session,
          onViewCart: () =>
              _kioskRepo.updateStep(session.uuid, KioskFlowStep.cart),
        );
      case KioskFlowStep.cart:
        return KioskCartPage(
          ...
          onCheckout: () =>
              _kioskRepo.updateStep(session.uuid, KioskFlowStep.payment),
        );
      case KioskFlowStep.payment:
        return KioskPaymentPage(
          ...
          session: session,
          onSuccess: () =>
              _kioskRepo.updateStep(session.uuid, KioskFlowStep.success),
        );
...
class KioskPaymentPage extends StatelessWidget {
  ...
  const KioskPaymentPage(
      {super.key, required this.session, required this.onSuccess});
