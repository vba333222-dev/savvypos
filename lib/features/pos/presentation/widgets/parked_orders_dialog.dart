          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<List<OrderTableData>>(
                stream: (db.select(db.orderTable)
                      ..where((t) => t.status.equals('OPEN')))
                    .watch(),
                builder: (context, snapshot) {
                  if (!snapshot.hasData || snapshot.data!.isEmpty) {
                    return Center(
                        child: SavvyText("No parked orders",
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        title: SavvyText(order.orderNumber,
                            style: SavvyTextStyle.bodyLarge),
                        subtitle: SavvyText(
                            DateFormat('h:mm a').format(order.transactionDate)),
                        trailing: Row(
                            ...
                            ElevatedButton(
                              onPressed: () {
                                ...
                                context.read<CartBloc>().add(
                                    CartEvent.retrieveOrder(order.uuid, ""));
