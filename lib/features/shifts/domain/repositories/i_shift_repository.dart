...
abstract class IShiftRepository {
  ...
  Future<ShiftSession> clockOut(String employeeUuid, {double tipsDeclared = 0.0});
  ...
  Future<List<ShiftSession>> getShiftHistory(String employeeUuid, DateTimeRange range);

  /// Get summary of hours worked for an employee in a date range
  Future<EmployeeShiftSummary> getEmployeeSummary(String employeeUuid, DateTimeRange range);
