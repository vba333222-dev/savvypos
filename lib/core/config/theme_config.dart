...
class SavvyTheme extends ThemeExtension<SavvyTheme> {
  ...
  ThemeExtension<SavvyTheme> lerp(ThemeExtension<SavvyTheme>? other, double t) {
    ...
    return SavvyTheme(
      ...
      shapes: shapes, // Shapes jarang berubah antar tema
      motion: motion, // Motion jarang berubah
...
class SavvyElevations {
  ...
  factory SavvyElevations.light() => const SavvyElevations(
      none: [],
      sm: [BoxShadow(color: Color(0x0D000000), offset: Offset(0, 1), blurRadius: 2)],
      md: [BoxShadow(color: Color(0x1A000000), offset: Offset(0, 4), blurRadius: 6, spreadRadius: -1)],
      lg: [BoxShadow(color: Color(0x1A000000), offset: Offset(0, 10), blurRadius: 15, spreadRadius: -3)],
      // The "Stitch" Floating Effect
      floating: [BoxShadow(color: Color(0x26000000), offset: Offset(0, 20), blurRadius: 25, spreadRadius: -5)],
    );

  factory SavvyElevations.dark() => const SavvyElevations(
      none: [],
      sm: [BoxShadow(color: Color(0x40000000), offset: Offset(0, 1), blurRadius: 2)],
      md: [BoxShadow(color: Color(0x66000000), offset: Offset(0, 4), blurRadius: 6, spreadRadius: -1)],
      lg: [BoxShadow(color: Color(0x80000000), offset: Offset(0, 10), blurRadius: 15, spreadRadius: -3)],
  ...
  SavvyElevations lerp(SavvyElevations other, double t) {
    // Helper untuk lerp List<BoxShadow>
