...
class EarnPointsUseCase {
  ...
  Future<LoyaltyMember> call({
    ...
    // 3. Update Member
    final member = await _repository.earnPoints(customerUuid, orderTotal, orderUuid: orderUuid);
...
class GetSegmentedMembersUseCase {
  ...
  Future<List<LoyaltyMember>> call(CampaignTriggerType trigger, {String? value}) async {
