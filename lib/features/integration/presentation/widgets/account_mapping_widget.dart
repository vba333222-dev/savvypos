...
class _AccountMappingWidgetState extends State<AccountMappingWidget>
    with TickerProviderStateMixin {
  // Mock Data
  final List<String> savvyCategories = [
    'Net Sales',
    'Cost of Goods Sold (COGS)',
    'Total Tax (PPN Keluaran)',
    'Total Discounts',
    'Cash Drawer Default'
  ];
                      ...
                      return Draggable<String>(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                isMapped ? Colors.purple.shade50 : Colors.white,
                      ...
                      return DragTarget<String>(
                        onAcceptWithDetails: (details) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text(
                                  'Mapped ${details.data} to ${acc['name']}')));
                        },
