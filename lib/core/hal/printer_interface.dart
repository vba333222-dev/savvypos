...
abstract class IPrinterService {
  ...
  Future<void> connect(String address, {PrinterConnectionType type = PrinterConnectionType.bluetooth});

  /// Disconnects from current printer
  Future<void> disconnect();

  /// Scans for available Bluetooth devices (and potentially network devices via mDNS later)
  Future<List<PrinterDevice>> scan({PrinterConnectionType type = PrinterConnectionType.bluetooth});
