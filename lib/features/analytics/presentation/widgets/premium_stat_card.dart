...
class _PremiumStatCardState extends State<PremiumStatCard>
  ...
  double? get _trendPercentage {
    ...
    return ((widget.value - widget.previousValue!) / widget.previousValue!) *
        100;
  }

  bool get _isPositiveTrend =>
      _trendPercentage != null && _trendPercentage! >= 0;
  ...
  Widget _buildSkeleton(SavvyColors colors) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        duration: 1200.ms, color: colors.borderDefault.withValues(alpha: 0.3));
  }
}
