...
class _FrontFace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final points = customer.totalPoints.toInt();
    
    // Tier Colors
    Color tierColor;
    if (points > 500) tierColor = const Color(0xFFFFD700); // Gold
    else if (points > 100) tierColor = const Color(0xFFC0C0C0); // Silver
    else tierColor = const Color(0xFFCD7F32); // Bronze
                  ...
                  children: [
                    ...
                    Text(
                      customer.lastVisitAt != null 
                         ? 'Last seen: ${DateFormat('MMM dd').format(customer.lastVisitAt!)}'
                         : 'New Customer',
