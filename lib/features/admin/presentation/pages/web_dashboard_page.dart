    ...
    return Scaffold(
      ...
      body: BlocBuilder<DashboardBloc, DashboardState>(
        builder: (context, state) {
          ...
          final salesData = (state is DashboardLoaded)
              ? state.last7DaysSales.map((e) => e.total).toList()
              : <double>[];
          // Mock data if empty for visualization
          final displaySalesData = salesData.isEmpty
              ? [120.0, 150.0, 180.0, 130.0, 220.0, 260.0, 310.0, 290.0]
              : salesData;

          final activeTables = 12; // Standardize/Mock until backend provides
          final pendingOrders =
              (state is DashboardLoaded) ? state.pendingSyncCount : 0;
            ...
            children: [
              Column(
                ...
                children: [
                  // Header
                  Padding(
                    padding: EdgeInsets.fromLTRB(theme.shapes.spacingLg,
                        theme.shapes.spacingLg, theme.shapes.spacingLg, 0),
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            SavvyText('Operational Overview • Online',
                        ...
                        StaggeredGridTile.count(
                          ...
                          child: BentoTile(
                            child: Padding(
                              ...
                              child: SalesVelocityChart(
                                  hourlyData: displaySalesData),
                            ),
                          ),
                        ),
                                    ...
                                    child: (state is DashboardLoaded)
                                        ? ListView.builder(
                                            ...
                                            itemBuilder: (ctx, idx) => _TopItem(
                                                rank: idx + 1,
                                                name: state.topProducts[idx]
                                                    .productName,
                                                count: state
                                                    .topProducts[idx].quantity
                                                    .toInt()),
                                          )
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (state is DashboardLoaded &&
                                    ...
                                    SavvyText(
                                        '• ${state.pendingSyncCount} Unsynced',
                                        color: theme.colors.stateWarning),
                                  SavvyText('• System Nominal',
                                      color: theme.colors.stateSuccess),
                                ],
                              ),
                            ),
