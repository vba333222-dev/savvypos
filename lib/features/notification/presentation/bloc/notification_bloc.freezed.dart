...
mixin _$NotificationEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NotificationItem item) receive,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(NotificationItem item)? receive,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$ReceiveImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({NotificationItem item});

  $NotificationItemCopyWith<$Res> get item;
}

/// @nodoc
class __$$ReceiveImplCopyWithImpl<$Res>
    extends _$NotificationEventCopyWithImpl<$Res, _$ReceiveImpl>
  ...
  @pragma('vm:prefer-inline')
  $NotificationItemCopyWith<$Res> get item {
    return $NotificationItemCopyWith<$Res>(_value.item, (value) {
...
class _$ReceiveImpl implements _Receive {
  ...
  @override
  String toString() {
    return 'NotificationEvent.receive(item: $item)';
  }
...
abstract class _Receive implements NotificationEvent {
  const factory _Receive(final NotificationItem item) = _$ReceiveImpl;

  NotificationItem get item;
  @JsonKey(ignore: true)
  _$$ReceiveImplCopyWith<_$ReceiveImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
...
abstract class $NotificationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<NotificationItem> items, int unreadCount});
}
...
class _$NotificationStateImpl implements _NotificationState {
  const _$NotificationStateImpl(
      {final List<NotificationItem> items = const [], this.unreadCount = 0})
      : _items = items;
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_items), unreadCount);
...
abstract class _NotificationState implements NotificationState {
  const factory _NotificationState(
      ...
      final int unreadCount}) = _$NotificationStateImpl;
...
mixin _$NotificationItem {
  ...
  String get type => throw _privateConstructorUsedError; // 'ALERT' or 'INFO'
