...
class PaymentMethodsDialog extends StatefulWidget {
  ...
  const PaymentMethodsDialog(
      {super.key, required this.totalAmount, required this.cartBloc});
...
class _PaymentMethodsDialogState extends State<PaymentMethodsDialog> {
            ...
            Expanded(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border(
                      right: BorderSide(color: theme.colors.borderDefault)),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SavvyText('Payment Method',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _buildSummaryLine(
                              'Total Due', widget.totalAmount, theme,
                              isBold: true),
                          SizedBox(height: 8),
                          _buildSummaryLine('Tendered', tenderAmount, theme),
                          Divider(),
                          _buildSummaryLine('Change', change, theme,
                              isHighlight: true),
                        ],
                      ),
                    ),
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.all(theme.shapes.spacingLg),
                      color: theme.colors
                          .bgPrimary, // slightly visible header for numpad
                      alignment: Alignment.centerRight,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          SavvyText('Enter Cash Amount',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          _QuickCashBtn(
                              '\$10', () => setState(() => _input = '10')),
                          _QuickCashBtn(
                              '\$20', () => setState(() => _input = '20')),
                          _QuickCashBtn(
                              '\$50', () => setState(() => _input = '50')),
                        ],
                      ),
                    ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      SavvyText('Follow instructions on terminal',
                          style: SavvyTextStyle.h3,
                          color: theme.colors.textSecondary),
                      SizedBox(height: 32),
                      ElevatedButton(
  ...
  Widget _buildSummaryLine(String label, double val, SavvyTheme theme,
    ...
    return Row(
      ...
      children: [
        SavvyText(label,
            style:
                isBold ? SavvyTextStyle.bodyLarge : SavvyTextStyle.bodyMedium,
            color: theme.colors.textSecondary),
        SavvyText('\$${val.toStringAsFixed(2)}',
            style: isHighlight
                ? SavvyTextStyle.h3
                : (isBold ? SavvyTextStyle.h3 : SavvyTextStyle.bodyMedium),
            color: isHighlight
